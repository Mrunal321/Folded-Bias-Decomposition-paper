...
module maj_fb_61 (input  wire [60:0] x, output wire maj);
  // Parameters: th=31, w=5, K=1, schedule=dadda
  wire K0 = 1'b1;
  ...
  wire d0_s_c0_20, d0_c_c0_20;
  wire d1_s_c0_21, d1_c_c0_21;
  ...
  wire d7_p_s_c0_30, d7_p_c_c0_30;
  ...
  fa u_c0_d0_triple_d0_s_c0_20(.a(raw_s_c0_0), .b(raw_s_c0_1), .cin(raw_s_c0_2), .sum(d0_s_c0_20), .cout(d0_c_c0_20));
  fa u_c0_d1_triple_d1_s_c0_21(.a(d0_s_c0_20), .b(raw_s_c0_3), .cin(raw_s_c0_4), .sum(d1_s_c0_21), .cout(d1_c_c0_21));
  fa u_c0_d1_triple_d1_s_c0_22(.a(raw_s_c0_5), .b(raw_s_c0_6), .cin(raw_s_c0_7), .sum(d1_s_c0_22), .cout(d1_c_c0_22));
  fa u_c0_d1_triple_d1_s_c0_23(.a(raw_s_c0_8), .b(raw_s_c0_9), .cin(raw_s_c0_10), .sum(d1_s_c0_23), .cout(d1_c_c0_23));
  fa u_c0_d2_triple_d2_s_c0_24(.a(d1_s_c0_21), .b(d1_s_c0_22), .cin(d1_s_c0_23), .sum(d2_s_c0_24), .cout(d2_c_c0_24));
  fa u_c0_d2_triple_d2_s_c0_25(.a(raw_s_c0_11), .b(raw_s_c0_12), .cin(raw_s_c0_13), .sum(d2_s_c0_25), .cout(d2_c_c0_25));
  fa u_c0_d3_triple_d3_s_c0_26(.a(d2_s_c0_24), .b(d2_s_c0_25), .cin(raw_s_c0_14), .sum(d3_s_c0_26), .cout(d3_c_c0_26));
  fa u_c0_d3_triple_d3_s_c0_27(.a(raw_s_c0_15), .b(raw_s_c0_16), .cin(raw_s_c0_17), .sum(d3_s_c0_27), .cout(d3_c_c0_27));
  fa u_c0_d4_triple_d4_s_c0_28(.a(d3_s_c0_26), .b(d3_s_c0_27), .cin(raw_s_c0_18), .sum(d4_s_c0_28), .cout(d4_c_c0_28));
  fa u_c0_d5_triple_d5_s_c0_29(.a(d4_s_c0_28), .b(raw_s_c0_19), .cin(x[60]), .sum(d5_s_c0_29), .cout(d5_c_c0_29));
  fa u_c0_d7_pair_d7_p_s_c0_30(.a(d5_s_c0_29), .b(K0), .cin(1'b0), .sum(d7_p_s_c0_30), .cout(d7_p_c_c0_30));
  ...
  fa u_c1_d3_triple_d3_s_c1_40(.a(raw_c_c0_19), .b(d0_c_c0_20), .cin(d1_c_c0_21), .sum(d3_s_c1_40), .cout(d3_c_c1_40));
  ...
  fa u_c1_d7_triple_d7_s_c1_45(.a(d6_s_c1_44), .b(d5_c_c0_29), .cin(d7_p_c_c0_30), .sum(d7_s_c1_45), .cout(d7_c_c1_45));
  ...
  assign maj = d0_c_c4_56;
endmodule

// FA count (folded-bias, CSA-only) for n=61: total=57
// -----------------------------------------------------------------------------
...
module maj_baseline_strict_61 (input  wire [60:0] x, output wire maj);
  // Scaffold parameters: p=6, N=2^6-1=63, th_N=32, paired constants=1, schedule=dadda
  ...
  fa u_c0_raw_triple_raw_s_c0_18(.a(x[54]), .b(x[55]), .cin(x[56]), .sum(raw_s_c0_18), .cout(raw_c_c0_18));
  fa u_c0_raw_triple_raw_s_c0_19(.a(x[57]), .b(x[58]), .cin(x[59]), .sum(raw_s_c0_19), .cout(raw_c_c0_19));
  fa u_c0_raw_triple_raw_s_c0_20(.a(x[60]), .b(1'b1), .cin(1'b0), .sum(raw_s_c0_20), .cout(raw_c_c0_20));
...
// FA count (baseline STRICT, scaffold) for n=61: CSA=57, CPA(th)=6, total=63