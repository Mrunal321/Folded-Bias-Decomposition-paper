...
module maj_fb_21 (input  wire [20:0] x, output wire maj);
  // Parameters: th=11, w=4, K=5, schedule=dadda
  wire K0 = 1'b1;
  wire K2 = 1'b1;
  ...
  wire d4_p_s_c0_10, d4_p_c_c0_10;
  ...
  fa u_c0_d4_pair_d4_p_s_c0_10(.a(d2_s_c0_9), .b(K0), .cin(1'b0), .sum(d4_p_s_c0_10), .cout(d4_p_c_c0_10));
  ...
  fa u_c1_d4_triple_d4_s_c1_15(.a(d3_s_c1_14), .b(d2_c_c0_9), .cin(d4_p_c_c0_10), .sum(d4_s_c1_15), .cout(d4_c_c1_15));
...
// FA count (folded-bias, CSA-only) for n=21: total=20
// -----------------------------------------------------------------------------
...
module maj_baseline_strict_21 (input  wire [20:0] x, output wire maj);
  // Scaffold parameters: p=5, N=2^5-1=31, th_N=16, paired constants=5, schedule=dadda
  ...
  fa u_c0_raw_triple_raw_s_c0_8(.a(1'b1), .b(1'b1), .cin(1'b0), .sum(raw_s_c0_8), .cout(raw_c_c0_8));
...
// FA count (baseline STRICT, scaffold) for n=21: CSA=26, CPA(th)=5, total=31