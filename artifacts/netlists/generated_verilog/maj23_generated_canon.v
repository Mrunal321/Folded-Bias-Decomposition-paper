...
module maj_fb_23 (input  wire [22:0] x, output wire maj);
  // Parameters: th=12, w=4, K=4, schedule=dadda
  wire K2 = 1'b1;
  ...
  wire d0_s_c0_7, d0_c_c0_7;
  wire d1_s_c0_8, d1_c_c0_8;
  wire d2_s_c0_9, d2_c_c0_9;
  wire d3_s_c0_10, d3_c_c0_10;
  wire d0_s_c1_11, d0_c_c1_11;
  wire d1_s_c1_12, d1_c_c1_12;
  wire d2_s_c1_13, d2_c_c1_13;
  wire d3_s_c1_14, d3_c_c1_14;
  wire d4_s_c1_15, d4_c_c1_15;
  wire d0_s_c2_16, d0_c_c2_16;
  wire d1_s_c2_17, d1_c_c2_17;
  wire d3_p_s_c2_18, d3_p_c_c2_18;
  wire d0_s_c3_19, d0_c_c3_19;
  ...
  fa u_c0_d0_triple_d0_s_c0_7(.a(raw_s_c0_0), .b(raw_s_c0_1), .cin(raw_s_c0_2), .sum(d0_s_c0_7), .cout(d0_c_c0_7));
  fa u_c0_d1_triple_d1_s_c0_8(.a(d0_s_c0_7), .b(raw_s_c0_3), .cin(raw_s_c0_4), .sum(d1_s_c0_8), .cout(d1_c_c0_8));
  fa u_c0_d2_triple_d2_s_c0_9(.a(d1_s_c0_8), .b(raw_s_c0_5), .cin(raw_s_c0_6), .sum(d2_s_c0_9), .cout(d2_c_c0_9));
  fa u_c0_d3_triple_d3_s_c0_10(.a(d2_s_c0_9), .b(x[21]), .cin(x[22]), .sum(d3_s_c0_10), .cout(d3_c_c0_10));
  fa u_c1_d0_triple_d0_s_c1_11(.a(raw_c_c0_0), .b(raw_c_c0_1), .cin(raw_c_c0_2), .sum(d0_s_c1_11), .cout(d0_c_c1_11));
  fa u_c1_d1_triple_d1_s_c1_12(.a(d0_s_c1_11), .b(raw_c_c0_3), .cin(raw_c_c0_4), .sum(d1_s_c1_12), .cout(d1_c_c1_12));
  fa u_c1_d2_triple_d2_s_c1_13(.a(d1_s_c1_12), .b(raw_c_c0_5), .cin(raw_c_c0_6), .sum(d2_s_c1_13), .cout(d2_c_c1_13));
  fa u_c1_d3_triple_d3_s_c1_14(.a(d2_s_c1_13), .b(d0_c_c0_7), .cin(d1_c_c0_8), .sum(d3_s_c1_14), .cout(d3_c_c1_14));
  fa u_c1_d4_triple_d4_s_c1_15(.a(d3_s_c1_14), .b(d2_c_c0_9), .cin(d3_c_c0_10), .sum(d4_s_c1_15), .cout(d4_c_c1_15));
  fa u_c2_d0_triple_d0_s_c2_16(.a(d0_c_c1_11), .b(d1_c_c1_12), .cin(d2_c_c1_13), .sum(d0_s_c2_16), .cout(d0_c_c2_16));
  fa u_c2_d1_triple_d1_s_c2_17(.a(d0_s_c2_16), .b(d3_c_c1_14), .cin(d4_c_c1_15), .sum(d1_s_c2_17), .cout(d1_c_c2_17));
  fa u_c2_d3_pair_d3_p_s_c2_18(.a(d1_s_c2_17), .b(K2), .cin(1'b0), .sum(d3_p_s_c2_18), .cout(d3_p_c_c2_18));
  fa u_c3_d0_triple_d0_s_c3_19(.a(d0_c_c2_16), .b(d1_c_c2_17), .cin(d3_p_c_c2_18), .sum(d0_s_c3_19), .cout(d0_c_c3_19));

  assign maj = d0_c_c3_19;
endmodule

// FA count (folded-bias, CSA-only) for n=23: total=20
// -----------------------------------------------------------------------------
...
module maj_baseline_strict_23 (input  wire [22:0] x, output wire maj);
  // Scaffold parameters: p=5, N=2^5-1=31, th_N=16, paired constants=4, schedule=dadda
  ...
  fa u_c0_raw_triple_raw_s_c0_5(.a(x[15]), .b(x[16]), .cin(x[17]), .sum(raw_s_c0_5), .cout(raw_c_c0_5));
  fa u_c0_raw_triple_raw_s_c0_6(.a(x[18]), .b(x[19]), .cin(x[20]), .sum(raw_s_c0_6), .cout(raw_c_c0_6));
  fa u_c0_raw_triple_raw_s_c0_7(.a(x[21]), .b(x[22]), .cin(1'b1), .sum(raw_s_c0_7), .cout(raw_c_c0_7));
  fa u_c0_raw_triple_raw_s_c0_8(.a(1'b1), .b(1'b1), .cin(1'b1), .sum(raw_s_c0_8), .cout(raw_c_c0_8));
  ...
  fa u_c0_d4_triple_d4_s_c0_14(.a(d3_s_c0_13), .b(raw_s_c0_9), .cin(1'b0), .sum(d4_s_c0_14), .cout(d4_c_c0_14));
...
// FA count (baseline STRICT, scaffold) for n=23: CSA=26, CPA(th)=5, total=31