...
module maj_fb_41 (input  wire [40:0] x, output wire maj);
  // Parameters: th=21, w=5, K=11, schedule=dadda
  wire K0 = 1'b1;
  wire K1 = 1'b1;
  wire K3 = 1'b1;
  ...
  wire d0_s_c0_13, d0_c_c0_13;
  wire d1_s_c0_14, d1_c_c0_14;
  wire d1_s_c0_15, d1_c_c0_15;
  wire d2_s_c0_16, d2_c_c0_16;
  wire d2_s_c0_17, d2_c_c0_17;
  wire d3_s_c0_18, d3_c_c0_18;
  wire d4_s_c0_19, d4_c_c0_19;
  wire d6_p_s_c0_20, d6_p_c_c0_20;
  ...
  fa u_c0_d0_triple_d0_s_c0_13(.a(raw_s_c0_0), .b(raw_s_c0_1), .cin(raw_s_c0_2), .sum(d0_s_c0_13), .cout(d0_c_c0_13));
  fa u_c0_d1_triple_d1_s_c0_14(.a(d0_s_c0_13), .b(raw_s_c0_3), .cin(raw_s_c0_4), .sum(d1_s_c0_14), .cout(d1_c_c0_14));
  fa u_c0_d1_triple_d1_s_c0_15(.a(raw_s_c0_5), .b(raw_s_c0_6), .cin(raw_s_c0_7), .sum(d1_s_c0_15), .cout(d1_c_c0_15));
  fa u_c0_d2_triple_d2_s_c0_16(.a(d1_s_c0_14), .b(d1_s_c0_15), .cin(raw_s_c0_8), .sum(d2_s_c0_16), .cout(d2_c_c0_16));
  fa u_c0_d2_triple_d2_s_c0_17(.a(raw_s_c0_9), .b(raw_s_c0_10), .cin(raw_s_c0_11), .sum(d2_s_c0_17), .cout(d2_c_c0_17));
  fa u_c0_d3_triple_d3_s_c0_18(.a(d2_s_c0_16), .b(d2_s_c0_17), .cin(raw_s_c0_12), .sum(d3_s_c0_18), .cout(d3_c_c0_18));
  fa u_c0_d4_triple_d4_s_c0_19(.a(d3_s_c0_18), .b(x[39]), .cin(x[40]), .sum(d4_s_c0_19), .cout(d4_c_c0_19));
  fa u_c0_d6_pair_d6_p_s_c0_20(.a(d4_s_c0_19), .b(K0), .cin(1'b0), .sum(d6_p_s_c0_20), .cout(d6_p_c_c0_20));
  ...
  fa u_c1_d2_triple_d2_s_c1_26(.a(raw_c_c0_11), .b(raw_c_c0_12), .cin(d0_c_c0_13), .sum(d2_s_c1_26), .cout(d2_c_c1_26));
  fa u_c1_d3_triple_d3_s_c1_27(.a(d2_s_c1_25), .b(d2_s_c1_26), .cin(d1_c_c0_14), .sum(d3_s_c1_27), .cout(d3_c_c1_27));
  fa u_c1_d3_triple_d3_s_c1_28(.a(d1_c_c0_15), .b(d2_c_c0_16), .cin(d2_c_c0_17), .sum(d3_s_c1_28), .cout(d3_c_c1_28));
  fa u_c1_d4_triple_d4_s_c1_29(.a(d3_s_c1_27), .b(d3_s_c1_28), .cin(d3_c_c0_18), .sum(d4_s_c1_29), .cout(d4_c_c1_29));
  fa u_c1_d5_triple_d5_s_c1_30(.a(d4_s_c1_29), .b(d4_c_c0_19), .cin(d6_p_c_c0_20), .sum(d5_s_c1_30), .cout(d5_c_c1_30));
...
// FA count (folded-bias, CSA-only) for n=41: total=41
// -----------------------------------------------------------------------------
...
module maj_baseline_strict_41 (input  wire [40:0] x, output wire maj);
  // Scaffold parameters: p=6, N=2^6-1=63, th_N=32, paired constants=11, schedule=dadda
  ...
  fa u_c0_raw_triple_raw_s_c0_11(.a(x[33]), .b(x[34]), .cin(x[35]), .sum(raw_s_c0_11), .cout(raw_c_c0_11));
  fa u_c0_raw_triple_raw_s_c0_12(.a(x[36]), .b(x[37]), .cin(x[38]), .sum(raw_s_c0_12), .cout(raw_c_c0_12));
  fa u_c0_raw_triple_raw_s_c0_13(.a(x[39]), .b(x[40]), .cin(1'b1), .sum(raw_s_c0_13), .cout(raw_c_c0_13));
  ...
  fa u_c0_raw_triple_raw_s_c0_17(.a(1'b1), .b(1'b0), .cin(1'b0), .sum(raw_s_c0_17), .cout(raw_c_c0_17));
...
// FA count (baseline STRICT, scaffold) for n=41: CSA=57, CPA(th)=6, total=63