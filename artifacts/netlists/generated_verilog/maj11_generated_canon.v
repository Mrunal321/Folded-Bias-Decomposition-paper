...
module maj_fb_11 (input  wire [10:0] x, output wire maj);
  // Parameters: th=6, w=3, K=2, schedule=dadda
  wire K1 = 1'b1;
  ...
  fa u_c0_d2_triple_d2_s_c0_4(.a(d0_s_c0_3), .b(x[9]), .cin(x[10]), .sum(d2_s_c0_4), .cout(d2_c_c0_4));
  fa u_c1_d0_triple_d0_s_c1_5(.a(raw_c_c0_0), .b(raw_c_c0_1), .cin(raw_c_c0_2), .sum(d0_s_c1_5), .cout(d0_c_c1_5));
  fa u_c1_d1_triple_d1_s_c1_6(.a(d0_s_c1_5), .b(d0_c_c0_3), .cin(d2_c_c0_4), .sum(d1_s_c1_6), .cout(d1_c_c1_6));
...
// FA count (folded-bias, CSA-only) for n=11: total=9
// -----------------------------------------------------------------------------
...
module maj_baseline_strict_11 (input  wire [10:0] x, output wire maj);
  // Scaffold parameters: p=4, N=2^4-1=15, th_N=8, paired constants=2, schedule=dadda
  ...
  fa u_c0_raw_triple_raw_s_c0_1(.a(x[3]), .b(x[4]), .cin(x[5]), .sum(raw_s_c0_1), .cout(raw_c_c0_1));
  fa u_c0_raw_triple_raw_s_c0_2(.a(x[6]), .b(x[7]), .cin(x[8]), .sum(raw_s_c0_2), .cout(raw_c_c0_2));
  fa u_c0_raw_triple_raw_s_c0_3(.a(x[9]), .b(x[10]), .cin(1'b1), .sum(raw_s_c0_3), .cout(raw_c_c0_3));
  fa u_c0_raw_triple_raw_s_c0_4(.a(1'b1), .b(1'b0), .cin(1'b0), .sum(raw_s_c0_4), .cout(raw_c_c0_4));
...
// FA count (baseline STRICT, scaffold) for n=11: CSA=11, CPA(th)=4, total=15