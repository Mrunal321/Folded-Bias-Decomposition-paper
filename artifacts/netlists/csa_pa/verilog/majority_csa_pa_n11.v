module csa_kogge_stone_prefix_11(input [10:0] x, output maj);
  wire KS_K1, KS_K3, d0_c_c0_3, d0_c_c1_5, d0_p_c_c2_7, d0_p_s_c2_7, d0_s_c0_3, d0_s_c1_5, d2_c_c0_4, d2_c_c1_6, d2_s_c0_4, d2_s_c1_6, ks_g1, ks_g3, ks_p1, ks_p3, ks_s0_g1, ks_s0_g2, ks_s0_g3, ks_s0_p1, ks_s0_p2, ks_s0_p3, ks_s0_t1, ks_s0_t2, ks_s0_t3, ks_s1_g2, ks_s1_g3, ks_s1_p2, ks_s1_p3, ks_s1_t2, ks_s1_t3, raw_c_c0_0, raw_c_c0_1, raw_c_c0_2, raw_s_c0_0, raw_s_c0_1, raw_s_c0_2;
  assign KS_K1 = 1'b1;
  assign KS_K3 = 1'b1;
  ...
  fa u4(.a(d0_s_c0_3), .b(x[9]), .cin(x[10]), .sum(d2_s_c0_4), .cout(d2_c_c0_4));
  fa u5(.a(raw_c_c0_0), .b(raw_c_c0_1), .cin(raw_c_c0_2), .sum(d0_s_c1_5), .cout(d0_c_c1_5));
  fa u6(.a(d0_s_c1_5), .b(d0_c_c0_3), .cin(d2_c_c0_4), .sum(d2_s_c1_6), .cout(d2_c_c1_6));
  fa u7(.a(d0_c_c1_5), .b(d2_c_c1_6), .cin(1'b0), .sum(d0_p_s_c2_7), .cout(d0_p_c_c2_7));
  assign ks_p1 = ~d2_s_c1_6;
  assign ks_g1 = d2_s_c1_6 & KS_K1;
  assign ks_p3 = ~d0_p_c_c2_7;
  assign ks_g3 = d0_p_c_c2_7 & KS_K3;
  assign ks_s0_p1 = ks_p1 & d2_s_c0_4;
  assign ks_s0_t1 = ks_p1 & 1'b0;
  assign ks_s0_g1 = ks_g1 | ks_s0_t1;
  assign ks_s0_p2 = d0_p_s_c2_7 & ks_p1;
  assign ks_s0_t2 = d0_p_s_c2_7 & ks_g1;
  assign ks_s0_g2 = 1'b0 | ks_s0_t2;
  assign ks_s0_p3 = ks_p3 & d0_p_s_c2_7;
  assign ks_s0_t3 = ks_p3 & 1'b0;
  assign ks_s0_g3 = ks_g3 | ks_s0_t3;
  assign ks_s1_p2 = ks_s0_p2 & d2_s_c0_4;
