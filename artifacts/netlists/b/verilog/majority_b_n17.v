module prior_strict_baseline_17(input [16:0] x, output maj);
  ...
  fa u5(.a(x[15]), .b(x[16]), .cin(1'b1), .sum(raw_s_c0_5), .cout(raw_c_c0_5));
  fa u6(.a(1'b1), .b(1'b1), .cin(1'b1), .sum(raw_s_c0_6), .cout(raw_c_c0_6));
  fa u7(.a(1'b1), .b(1'b1), .cin(1'b1), .sum(raw_s_c0_7), .cout(raw_c_c0_7));
  fa u8(.a(1'b0), .b(1'b0), .cin(1'b0), .sum(raw_s_c0_8), .cout(raw_c_c0_8));
