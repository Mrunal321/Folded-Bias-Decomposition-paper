module prior_strict_baseline_11(input [10:0] x, output maj);
  ...
  fa u3(.a(x[9]), .b(x[10]), .cin(1'b1), .sum(raw_s_c0_3), .cout(raw_c_c0_3));
  fa u4(.a(1'b1), .b(1'b0), .cin(1'b0), .sum(raw_s_c0_4), .cout(raw_c_c0_4));
