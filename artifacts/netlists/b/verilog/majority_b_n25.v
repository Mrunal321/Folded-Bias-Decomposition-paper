module prior_strict_baseline_25(input [24:0] x, output maj);
  ...
  fa u8(.a(x[24]), .b(1'b1), .cin(1'b1), .sum(raw_s_c0_8), .cout(raw_c_c0_8));
  fa u9(.a(1'b1), .b(1'b0), .cin(1'b0), .sum(raw_s_c0_9), .cout(raw_c_c0_9));
