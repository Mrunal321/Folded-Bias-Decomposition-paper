module prior_strict_baseline_23(input [22:0] x, output maj);
  ...
  fa u7(.a(x[21]), .b(x[22]), .cin(1'b1), .sum(raw_s_c0_7), .cout(raw_c_c0_7));
  fa u8(.a(1'b1), .b(1'b1), .cin(1'b1), .sum(raw_s_c0_8), .cout(raw_c_c0_8));
