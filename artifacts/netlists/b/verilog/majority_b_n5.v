module prior_strict_baseline_5(input [4:0] x, output maj);
  ...
  fa u1(.a(x[3]), .b(x[4]), .cin(1'b1), .sum(raw_s_c0_1), .cout(raw_c_c0_1));
  fa u2(.a(raw_s_c0_0), .b(raw_s_c0_1), .cin(1'b0), .sum(d0_s_c0_2), .cout(d0_c_c0_2));
