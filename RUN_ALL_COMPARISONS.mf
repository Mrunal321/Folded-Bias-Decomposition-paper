...
cd ./Folded_Bias-Decomposition

python3 --version
./abc/abc -h

If mockturtle scorer is needed:
test -x ./Folded_Bias-Decomposition/tools/mockturtle_mig_opt/build/mockturtle_mig_opt && echo "mockturtle binary OK"

If CirKit QCA/STMG is needed:
./Mockturtle-mMIG-main/experiments-dac19-flow/.venv/bin/python -c "import cirkit; print('cirkit OK')"
...
cd ./Folded_Bias-Decomposition
/usr/bin/python3 ./Folded_Bias-Decomposition/compare_raw_light_metrics.py \
  --n-start 5 \
  --n-end 51 \
  --output ./Folded_Bias-Decomposition/results/raw_light_metrics_5_51.csv

Output file:
./Folded_Bias-Decomposition/results/raw_light_metrics_5_51.csv
...
cd ./Folded_Bias-Decomposition
/usr/bin/python3 ./Folded_Bias-Decomposition/compare_abc_mapped_metrics.py \
  --n-start 5 \
  --n-end 51 \
  --abc-bin ./abc/abc \
  --output ./Folded_Bias-Decomposition/results/abc_mapped_compare_5_51.csv

Output file:
./Folded_Bias-Decomposition/results/abc_mapped_compare_5_51.csv

Compact reshaped summary (already generated once):
./Folded_Bias-Decomposition/results/abc_mapped_summary_5_51.csv
...
/usr/bin/python3 ./Folded_Bias-Decomposition/compare_abc_mapped_metrics.py \
  ...
  --n-end 51 \
  --abc-bin ./abc/abc \
  --std-lib ./mockturtle/experiments/cell_libraries/sky130.genlib \
  --std-lib ./mockturtle/experiments/cell_libraries/asap7.genlib \
  --std-lib ./mockturtle/experiments/cell_libraries/mcnc.genlib \
  --output ./Folded_Bias-Decomposition/results/abc_mapped_compare_5_51.csv
...
./Mockturtle-mMIG-main/experiments-dac19-flow/.venv/bin/python

Command:

cd ./Folded_Bias-Decomposition
./Mockturtle-mMIG-main/experiments-dac19-flow/.venv/bin/python \
  ./Folded_Bias-Decomposition/compare_cirkit_qca_stmg.py \
  --n-start 5 \
  --n-end 51 \
  --abc-bin ./abc/abc \
  --output ./Folded_Bias-Decomposition/results/cirkit_qca_stmg_compare_5_51.csv

Output file:
./Folded_Bias-Decomposition/results/cirkit_qca_stmg_compare_5_51.csv
...
cd ./Folded_Bias-Decomposition
sed -n '1,20p' ./Folded_Bias-Decomposition/results/raw_light_metrics_5_51.csv
sed -n '1,20p' ./Folded_Bias-Decomposition/results/abc_mapped_compare_5_51.csv
sed -n '1,20p' ./Folded_Bias-Decomposition/results/cirkit_qca_stmg_compare_5_51.csv
...
cd ./Folded_Bias-Decomposition
/usr/bin/python3 ./Folded_Bias-Decomposition/generate_paper_package.py \
  --n-start 5 \
  --n-end 61 \
  --abc-bin ./abc/abc \
  --cirkit-python ./Mockturtle-mMIG-main/experiments-dac19-flow/.venv/bin/python

Default output folder for this run:
./Folded_Bias-Decomposition/results/paper_package_5_61
...
cd ./Folded_Bias-Decomposition
/usr/bin/python3 ./Folded_Bias-Decomposition/compare_vivado_stats.py \
  --n-start 5 \
  --n-end 51 \
  --part xc7a100tcsg324-1 \
  --vivado-bin /tools/Xilinx/Vivado/2024.2/bin/vivado \
  --synth-only \
  --output-dir ./Folded_Bias-Decomposition/results/vivado_compare_5_51_synth

Output files:
- ./Folded_Bias-Decomposition/results/vivado_compare_5_51_synth/vivado_detailed.csv
- ./Folded_Bias-Decomposition/results/vivado_compare_5_51_synth/vivado_comparison.csv
- per-design reports/logs under:
  ./Folded_Bias-Decomposition/results/vivado_compare_5_51_synth/runs
...
cd ./Folded_Bias-Decomposition
sed -n '1,20p' ./Folded_Bias-Decomposition/results/vivado_compare_5_51_synth/vivado_comparison.csv
...
cd ./Folded_Bias-Decomposition
/usr/bin/python3 ./Folded_Bias-Decomposition/generate_vivado_paper_package.py \
  --comparison-csv ./Folded_Bias-Decomposition/results/vivado_compare_5_61_synth/vivado_comparison.csv \
  --detailed-csv ./Folded_Bias-Decomposition/results/vivado_compare_5_61_synth/vivado_detailed.csv

Default output:
- ./Folded_Bias-Decomposition/results/vivado_paper_package_5_61
