...
module maj_fb_51 (input  wire [50:0] x, output wire maj);
  // Parameters: th=26, w=5, K=6, schedule=dadda
  wire K1 = 1'b1;
  wire K2 = 1'b1;
  ...
  wire d0_s_c0_17, d0_c_c0_17;
  wire d0_s_c0_18, d0_c_c0_18;
  wire d1_s_c0_19, d1_c_c0_19;
  wire d1_s_c0_20, d1_c_c0_20;
  wire d2_s_c0_21, d2_c_c0_21;
  wire d3_s_c0_22, d3_c_c0_22;
  wire d4_s_c0_23, d4_c_c0_23;
  wire d5_s_c0_24, d5_c_c0_24;
  wire d0_s_c1_25, d0_c_c1_25;
  wire d0_s_c1_26, d0_c_c1_26;
  wire d0_s_c1_27, d0_c_c1_27;
  wire d1_s_c1_28, d1_c_c1_28;
  wire d1_s_c1_29, d1_c_c1_29;
  wire d1_s_c1_30, d1_c_c1_30;
  wire d2_s_c1_31, d2_c_c1_31;
  wire d2_s_c1_32, d2_c_c1_32;
  wire d3_s_c1_33, d3_c_c1_33;
  wire d3_s_c1_34, d3_c_c1_34;
  wire d4_s_c1_35, d4_c_c1_35;
  wire d5_s_c1_36, d5_c_c1_36;
  wire d7_p_s_c1_37, d7_p_c_c1_37;
  wire d0_s_c2_38, d0_c_c2_38;
  wire d1_s_c2_39, d1_c_c2_39;
  wire d2_s_c2_40, d2_c_c2_40;
  wire d2_s_c2_41, d2_c_c2_41;
  wire d3_s_c2_42, d3_c_c2_42;
  wire d4_s_c2_43, d4_c_c2_43;
  wire d6_p_s_c2_44, d6_p_c_c2_44;
  wire d0_s_c3_45, d0_c_c3_45;
  wire d1_s_c3_46, d1_c_c3_46;
  wire d3_s_c3_47, d3_c_c3_47;
  wire d0_s_c4_48, d0_c_c4_48;
  ...
  fa u_c0_d0_triple_d0_s_c0_17(.a(raw_s_c0_0), .b(raw_s_c0_1), .cin(raw_s_c0_2), .sum(d0_s_c0_17), .cout(d0_c_c0_17));
  fa u_c0_d0_triple_d0_s_c0_18(.a(raw_s_c0_3), .b(raw_s_c0_4), .cin(raw_s_c0_5), .sum(d0_s_c0_18), .cout(d0_c_c0_18));
  fa u_c0_d1_triple_d1_s_c0_19(.a(d0_s_c0_17), .b(d0_s_c0_18), .cin(raw_s_c0_6), .sum(d1_s_c0_19), .cout(d1_c_c0_19));
  fa u_c0_d1_triple_d1_s_c0_20(.a(raw_s_c0_7), .b(raw_s_c0_8), .cin(raw_s_c0_9), .sum(d1_s_c0_20), .cout(d1_c_c0_20));
  fa u_c0_d2_triple_d2_s_c0_21(.a(d1_s_c0_19), .b(d1_s_c0_20), .cin(raw_s_c0_10), .sum(d2_s_c0_21), .cout(d2_c_c0_21));
  fa u_c0_d3_triple_d3_s_c0_22(.a(d2_s_c0_21), .b(raw_s_c0_11), .cin(raw_s_c0_12), .sum(d3_s_c0_22), .cout(d3_c_c0_22));
  fa u_c0_d4_triple_d4_s_c0_23(.a(d3_s_c0_22), .b(raw_s_c0_13), .cin(raw_s_c0_14), .sum(d4_s_c0_23), .cout(d4_c_c0_23));
  fa u_c0_d5_triple_d5_s_c0_24(.a(d4_s_c0_23), .b(raw_s_c0_15), .cin(raw_s_c0_16), .sum(d5_s_c0_24), .cout(d5_c_c0_24));
  fa u_c1_d0_triple_d0_s_c1_25(.a(raw_c_c0_0), .b(raw_c_c0_1), .cin(raw_c_c0_2), .sum(d0_s_c1_25), .cout(d0_c_c1_25));
  fa u_c1_d0_triple_d0_s_c1_26(.a(raw_c_c0_3), .b(raw_c_c0_4), .cin(raw_c_c0_5), .sum(d0_s_c1_26), .cout(d0_c_c1_26));
  fa u_c1_d0_triple_d0_s_c1_27(.a(raw_c_c0_6), .b(raw_c_c0_7), .cin(raw_c_c0_8), .sum(d0_s_c1_27), .cout(d0_c_c1_27));
  fa u_c1_d1_triple_d1_s_c1_28(.a(d0_s_c1_25), .b(d0_s_c1_26), .cin(d0_s_c1_27), .sum(d1_s_c1_28), .cout(d1_c_c1_28));
  fa u_c1_d1_triple_d1_s_c1_29(.a(raw_c_c0_9), .b(raw_c_c0_10), .cin(raw_c_c0_11), .sum(d1_s_c1_29), .cout(d1_c_c1_29));
  fa u_c1_d1_triple_d1_s_c1_30(.a(raw_c_c0_12), .b(raw_c_c0_13), .cin(raw_c_c0_14), .sum(d1_s_c1_30), .cout(d1_c_c1_30));
  fa u_c1_d2_triple_d2_s_c1_31(.a(d1_s_c1_28), .b(d1_s_c1_29), .cin(d1_s_c1_30), .sum(d2_s_c1_31), .cout(d2_c_c1_31));
  fa u_c1_d2_triple_d2_s_c1_32(.a(raw_c_c0_15), .b(raw_c_c0_16), .cin(d0_c_c0_17), .sum(d2_s_c1_32), .cout(d2_c_c1_32));
  fa u_c1_d3_triple_d3_s_c1_33(.a(d2_s_c1_31), .b(d2_s_c1_32), .cin(d0_c_c0_18), .sum(d3_s_c1_33), .cout(d3_c_c1_33));
  fa u_c1_d3_triple_d3_s_c1_34(.a(d1_c_c0_19), .b(d1_c_c0_20), .cin(d2_c_c0_21), .sum(d3_s_c1_34), .cout(d3_c_c1_34));
  fa u_c1_d4_triple_d4_s_c1_35(.a(d3_s_c1_33), .b(d3_s_c1_34), .cin(d3_c_c0_22), .sum(d4_s_c1_35), .cout(d4_c_c1_35));
  fa u_c1_d5_triple_d5_s_c1_36(.a(d4_s_c1_35), .b(d4_c_c0_23), .cin(d5_c_c0_24), .sum(d5_s_c1_36), .cout(d5_c_c1_36));
  fa u_c1_d7_pair_d7_p_s_c1_37(.a(d5_s_c1_36), .b(K1), .cin(1'b0), .sum(d7_p_s_c1_37), .cout(d7_p_c_c1_37));
  fa u_c2_d0_triple_d0_s_c2_38(.a(d0_c_c1_25), .b(d0_c_c1_26), .cin(d0_c_c1_27), .sum(d0_s_c2_38), .cout(d0_c_c2_38));
  fa u_c2_d1_triple_d1_s_c2_39(.a(d0_s_c2_38), .b(d1_c_c1_28), .cin(d1_c_c1_29), .sum(d1_s_c2_39), .cout(d1_c_c2_39));
  fa u_c2_d2_triple_d2_s_c2_40(.a(d1_s_c2_39), .b(d1_c_c1_30), .cin(d2_c_c1_31), .sum(d2_s_c2_40), .cout(d2_c_c2_40));
  fa u_c2_d2_triple_d2_s_c2_41(.a(d2_c_c1_32), .b(d3_c_c1_33), .cin(d3_c_c1_34), .sum(d2_s_c2_41), .cout(d2_c_c2_41));
  fa u_c2_d3_triple_d3_s_c2_42(.a(d2_s_c2_40), .b(d2_s_c2_41), .cin(d4_c_c1_35), .sum(d3_s_c2_42), .cout(d3_c_c2_42));
  fa u_c2_d4_triple_d4_s_c2_43(.a(d3_s_c2_42), .b(d5_c_c1_36), .cin(d7_p_c_c1_37), .sum(d4_s_c2_43), .cout(d4_c_c2_43));
  fa u_c2_d6_pair_d6_p_s_c2_44(.a(d4_s_c2_43), .b(K2), .cin(1'b0), .sum(d6_p_s_c2_44), .cout(d6_p_c_c2_44));
  fa u_c3_d0_triple_d0_s_c3_45(.a(d0_c_c2_38), .b(d1_c_c2_39), .cin(d2_c_c2_40), .sum(d0_s_c3_45), .cout(d0_c_c3_45));
  fa u_c3_d1_triple_d1_s_c3_46(.a(d0_s_c3_45), .b(d2_c_c2_41), .cin(d3_c_c2_42), .sum(d1_s_c3_46), .cout(d1_c_c3_46));
  fa u_c3_d3_triple_d3_s_c3_47(.a(d1_s_c3_46), .b(d4_c_c2_43), .cin(d6_p_c_c2_44), .sum(d3_s_c3_47), .cout(d3_c_c3_47));
  fa u_c4_d0_triple_d0_s_c4_48(.a(d0_c_c3_45), .b(d1_c_c3_46), .cin(d3_c_c3_47), .sum(d0_s_c4_48), .cout(d0_c_c4_48));

  assign maj = d0_c_c4_48;
endmodule

// FA count (folded-bias, CSA-only) for n=51: total=49
// -----------------------------------------------------------------------------
...
module maj_baseline_strict_51 (input  wire [50:0] x, output wire maj);
  // Scaffold parameters: p=6, N=2^6-1=63, th_N=32, paired constants=6, schedule=dadda
  ...
  fa u_c0_raw_triple_raw_s_c0_15(.a(x[45]), .b(x[46]), .cin(x[47]), .sum(raw_s_c0_15), .cout(raw_c_c0_15));
  fa u_c0_raw_triple_raw_s_c0_16(.a(x[48]), .b(x[49]), .cin(x[50]), .sum(raw_s_c0_16), .cout(raw_c_c0_16));
  fa u_c0_raw_triple_raw_s_c0_17(.a(1'b1), .b(1'b1), .cin(1'b1), .sum(raw_s_c0_17), .cout(raw_c_c0_17));
  fa u_c0_raw_triple_raw_s_c0_18(.a(1'b1), .b(1'b1), .cin(1'b1), .sum(raw_s_c0_18), .cout(raw_c_c0_18));
...
// FA count (baseline STRICT, scaffold) for n=51: CSA=57, CPA(th)=6, total=63