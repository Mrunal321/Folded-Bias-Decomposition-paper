...
module maj_fb_17 (input  wire [16:0] x, output wire maj);
  // Parameters: th=9, w=4, K=7, schedule=wallace
  wire K0 = 1'b1;
  wire K1 = 1'b1;
  wire K2 = 1'b1;
  ...
  wire w1_s_c0_7, w1_c_c0_7;
  wire w2_p_s_c0_8, w2_p_c_c0_8;
  ...
  fa u_c0_w0_triple_w0_s_c0_6(.a(raw_s_c0_3), .b(raw_s_c0_4), .cin(x[15]), .sum(w0_s_c0_6), .cout(w0_c_c0_6));
  fa u_c0_w1_triple_w1_s_c0_7(.a(w0_s_c0_5), .b(w0_s_c0_6), .cin(x[16]), .sum(w1_s_c0_7), .cout(w1_c_c0_7));
  fa u_c0_w2_pair_w2_p_s_c0_8(.a(w1_s_c0_7), .b(K0), .cin(1'b0), .sum(w2_p_s_c0_8), .cout(w2_p_c_c0_8));
  fa u_c1_w0_triple_w0_s_c1_9(.a(raw_c_c0_0), .b(raw_c_c0_1), .cin(raw_c_c0_2), .sum(w0_s_c1_9), .cout(w0_c_c1_9));
  fa u_c1_w0_triple_w0_s_c1_10(.a(raw_c_c0_3), .b(raw_c_c0_4), .cin(w0_c_c0_5), .sum(w0_s_c1_10), .cout(w0_c_c1_10));
  fa u_c1_w0_triple_w0_s_c1_11(.a(w0_c_c0_6), .b(w1_c_c0_7), .cin(w2_p_c_c0_8), .sum(w0_s_c1_11), .cout(w0_c_c1_11));
...
// FA count (folded-bias, CSA-only) for n=17: total=18
// -----------------------------------------------------------------------------
...
module maj_baseline_strict_17 (input  wire [16:0] x, output wire maj);
  // Scaffold parameters: p=5, N=2^5-1=31, th_N=16, paired constants=7, schedule=wallace
  ...
  fa u_c0_raw_triple_raw_s_c0_3(.a(x[9]), .b(x[10]), .cin(x[11]), .sum(raw_s_c0_3), .cout(raw_c_c0_3));
  fa u_c0_raw_triple_raw_s_c0_4(.a(x[12]), .b(x[13]), .cin(x[14]), .sum(raw_s_c0_4), .cout(raw_c_c0_4));
  fa u_c0_raw_triple_raw_s_c0_5(.a(x[15]), .b(x[16]), .cin(1'b1), .sum(raw_s_c0_5), .cout(raw_c_c0_5));
  fa u_c0_raw_triple_raw_s_c0_6(.a(1'b1), .b(1'b1), .cin(1'b1), .sum(raw_s_c0_6), .cout(raw_c_c0_6));
  fa u_c0_raw_triple_raw_s_c0_7(.a(1'b1), .b(1'b1), .cin(1'b1), .sum(raw_s_c0_7), .cout(raw_c_c0_7));
  fa u_c0_raw_triple_raw_s_c0_8(.a(1'b0), .b(1'b0), .cin(1'b0), .sum(raw_s_c0_8), .cout(raw_c_c0_8));
...
// FA count (baseline STRICT, scaffold) for n=17: CSA=26, CPA(th)=5, total=31