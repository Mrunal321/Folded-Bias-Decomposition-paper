...
module maj_fb_9 (input  wire [8:0] x, output wire maj);
  // Parameters: th=5, w=3, K=3, schedule=dadda
  wire K0 = 1'b1;
  wire K1 = 1'b1;
  ...
  wire d0_s_c0_3, d0_c_c0_3;
  wire d2_p_s_c0_4, d2_p_c_c0_4;
  wire d0_s_c1_5, d0_c_c1_5;
  wire d1_s_c1_6, d1_c_c1_6;
  wire d3_p_s_c1_7, d3_p_c_c1_7;
  wire d0_s_c2_8, d0_c_c2_8;
  ...
  fa u_c0_d0_triple_d0_s_c0_3(.a(raw_s_c0_0), .b(raw_s_c0_1), .cin(raw_s_c0_2), .sum(d0_s_c0_3), .cout(d0_c_c0_3));
  fa u_c0_d2_pair_d2_p_s_c0_4(.a(d0_s_c0_3), .b(K0), .cin(1'b0), .sum(d2_p_s_c0_4), .cout(d2_p_c_c0_4));
  fa u_c1_d0_triple_d0_s_c1_5(.a(raw_c_c0_0), .b(raw_c_c0_1), .cin(raw_c_c0_2), .sum(d0_s_c1_5), .cout(d0_c_c1_5));
  fa u_c1_d1_triple_d1_s_c1_6(.a(d0_s_c1_5), .b(d0_c_c0_3), .cin(d2_p_c_c0_4), .sum(d1_s_c1_6), .cout(d1_c_c1_6));
  fa u_c1_d3_pair_d3_p_s_c1_7(.a(d1_s_c1_6), .b(K1), .cin(1'b0), .sum(d3_p_s_c1_7), .cout(d3_p_c_c1_7));
  fa u_c2_d0_triple_d0_s_c2_8(.a(d0_c_c1_5), .b(d1_c_c1_6), .cin(d3_p_c_c1_7), .sum(d0_s_c2_8), .cout(d0_c_c2_8));

  assign maj = d0_c_c2_8;
endmodule

// FA count (folded-bias, CSA-only) for n=9: total=9
// -----------------------------------------------------------------------------
...
module maj_baseline_strict_9 (input  wire [8:0] x, output wire maj);
  // Scaffold parameters: p=4, N=2^4-1=15, th_N=8, paired constants=3, schedule=dadda
  ...
  fa u_c0_raw_triple_raw_s_c0_1(.a(x[3]), .b(x[4]), .cin(x[5]), .sum(raw_s_c0_1), .cout(raw_c_c0_1));
  fa u_c0_raw_triple_raw_s_c0_2(.a(x[6]), .b(x[7]), .cin(x[8]), .sum(raw_s_c0_2), .cout(raw_c_c0_2));
  fa u_c0_raw_triple_raw_s_c0_3(.a(1'b1), .b(1'b1), .cin(1'b1), .sum(raw_s_c0_3), .cout(raw_c_c0_3));
  fa u_c0_raw_triple_raw_s_c0_4(.a(1'b0), .b(1'b0), .cin(1'b0), .sum(raw_s_c0_4), .cout(raw_c_c0_4));
...
// FA count (baseline STRICT, scaffold) for n=9: CSA=11, CPA(th)=4, total=15